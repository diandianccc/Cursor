...
const AggregatedPainpointView = ({ stages, onSwitchToStepView }) => {
  // Collect all tasks and organize their steps, pain points and opportunities
  const allTasks = [];
  ...
  stages.forEach(stage => {
    stage.tasks.forEach(task => {
      ...
      // Add all tasks (even those without steps/painpoints/opportunities)
      allTasks.push({
        stageName: stage.name,
        taskName: task.name,
        taskId: task.id,
    ...
    <div className="overflow-x-auto">
      <div className="min-w-full">
          ...
          <div className="flex border-b border-gray-200">
            <div className="w-32 bg-blue-50 p-4 border-r border-gray-200 flex items-center">
            ...
            <div className="flex flex-1">
              {allTasks.map((task) => (
                <div key={`task-${task.taskId}`} className="min-w-64 p-4 border-r border-gray-200 last:border-r-0">
          ...
          {/* Steps Row */}
          <div className="flex border-b border-gray-200">
            <div className="w-32 bg-indigo-50 p-4 border-r border-gray-200 flex items-center">
              <div className="flex items-center gap-2">
            ...
            <div className="flex flex-1">
              {allTasks.map((task) => (
                <div key={`steps-${task.taskId}`} className="min-w-64 p-4 border-r border-gray-200 last:border-r-0">
          ...
          {/* Pain Points Row */}
          <div className="flex border-b border-gray-200">
            <div className="w-32 bg-red-50 p-4 border-r border-gray-200 flex items-center">
              <div className="flex items-center gap-2">
            ...
            <div className="flex flex-1">
              {allTasks.map((task) => (
                <div key={`pain-${task.taskId}`} className="min-w-64 p-4 border-r border-gray-200 last:border-r-0">
                  <div className="space-y-2 max-h-48 overflow-y-auto">
          ...
          {/* Opportunities Row */}
          <div className="flex">
            <div className="w-32 bg-green-50 p-4 border-r border-gray-200 flex items-center">
              <div className="flex items-center gap-2">
            ...
            <div className="flex flex-1">
              {allTasks.map((task) => (
                <div key={`opp-${task.taskId}`} className="min-w-64 p-4 border-r border-gray-200 last:border-r-0">
                  <div className="space-y-2 max-h-48 overflow-y-auto">
